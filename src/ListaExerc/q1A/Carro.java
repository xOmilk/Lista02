...
public class Carro {
    ...
    public void cadastrar(int codigo, String marca, String cor, String modelo, int anoFab, int numPortas, int qntdDisponivel, boolean isBasic) {
        this.codigo = codigo;
        this.marca = marca;
        this.cor = cor;
        this.modelo = modelo;
    ...
    public void editar(int codigo, String marca, String cor, String modelo, int anoFab, int numPortas, int qntdDisponivel, boolean isBasic) {
        this.codigo = codigo;
        this.marca = marca;
        this.cor = cor;
        this.modelo = modelo;
